...
- `20260730-232440` 客户端候选已完成：H5“退出文字对话”恢复为明确按钮；H5 与小程序对话区
  ...
  已通过。计划只切换 H5 静态 release 并上传小程序 `0.8.65` 体验版；runtime 保持
  `20260730-224522`，H5 直接回滚点为 `20260730-224522`。生产与上传结果见
  `docs/releases/20260730-232440.md`。
