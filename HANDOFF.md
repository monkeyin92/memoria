...
- `20260730-233824` H5 静态候选在 `20260730-232440` 线上视觉验收后补充：普通竖屏和低高度
  横屏的对话卡均由卡片自身纵向滚动，长回答不再溢出卡片或贴入固定底栏。其余单条当前发言、
  乐观用户展示、助手流式替换、single-flight、权威终稿和隐私边界不变。计划只切换 H5；
  runtime 保持 `20260730-224522`，直接 H5 回滚点为 `20260730-232440`，小程序 `0.8.65`
  从本版本最终源码上传体验版。发布记录见 `docs/releases/20260730-233824.md`。
