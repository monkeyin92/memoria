...
- Control API：`memoria-control-api:20260903-1515-force-wechat-phone-control-api`，overlay revision `d14f3a3cd86dea31356efd931270bf5169956d93`（openid-only 老账号静默恢复时强制 `phone_authorization_required`，否则主人声纹所需已验证成人永远升不上去）。栈环境字段仍对齐 `20260901-0945-wake-word-whitelist` / `7ca3d4ec531305d968d67ef1bb13b944e566e4cf`；容器 healthy、restart=0。自动全量发版未走，手动 overlay cutover；收据 `/opt/memoria/component-releases/20260903-1515-force-wechat-phone-control-api/`。紧邻回滚 `memoria-control-api:rollback-20260903-1515-force-wechat-phone-control-api-pre-control` → `20260901-0945-wake-word-whitelist`。小程序「我的」游客文案已改但需开发者工具上传后才对用户可见；现网客户端已能处理 428 并进入「授权手机号并登录」。
