...
const companionTemplate = fs.readFileSync(path.join(root, "pages/companion/index.wxml"), "utf8");
...
test("profile keeps custom persona recording and opens the companion picker", () => {
