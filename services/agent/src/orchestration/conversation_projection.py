...
from services.agent.src.orchestration.projection_types import (
    FloorState as FloorState,
)
from services.agent.src.orchestration.projection_types import (
    PhaseReason as PhaseReason,
)
from services.agent.src.orchestration.projection_types import (
    ProjectionEventKind as ProjectionEventKind,
)
from services.agent.src.orchestration.projection_types import (
    ProjectionRejectReason as ProjectionRejectReason,
)
from services.agent.src.orchestration.projection_types import (
    SpeakerClass as SpeakerClass,
)
from services.agent.src.orchestration.projection_types import (
