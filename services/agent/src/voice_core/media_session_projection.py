        ...
        *,
        ...
        try:
            ...
            if current_fence.matches(fence):
                ...
                # A same-turn auxiliary bump (e.g. historical second cue, or
                # another follow-up acknowledgement) advanced the runtime
                # without a new user turn. Accept the answer against its
                # delegation fence, then rebind it below.
