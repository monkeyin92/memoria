...
先查询再回答；联网查询可以先播一句确认“稍等，我查询一下可能要一会儿。”，随后在后台查询，
查到结果后只播报最相关部分。没有可靠结果就明确说暂时没有查到，不要把猜测说成实时事实，
也不要把用户的私人资料或敏感信息拿去查询。
...
SPEAKER_ENROLLMENT_INCOMPLETE_PHRASE = "这次没录上，请再唤醒我试一次。"
SPEAKER_ENROLLMENT_NEED_CONSENT_PHRASE = "请先在小程序点一下登记，再唤醒我。"
