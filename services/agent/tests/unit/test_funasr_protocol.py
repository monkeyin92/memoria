...
def test_run_task_sends_vad_model_only_to_qwen_audio_31() -> None:
    qwen = build_run_task(task_id="t1", model="qwen-audio-3.1-asr-flash-streaming", vad_model="near_meeting_16k")
    assert qwen["payload"]["parameters"]["vad_model"] == "near_meeting_16k"

    legacy = build_run_task(task_id="t1", vad_model="near_meeting_16k")
