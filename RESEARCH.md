...
任何阶段都不做：7 寸数字人屏、跌倒/医疗级看护硬件、智家中枢、全屋 OS、运动巡航形态、耳机 Agent、微信实时语音。阶段外（后续阶段方向，当前不投入但不是反定位）：老年陪伴 / 人物复刻 / 人生故事册属后期，年轻人潮玩属再后期——Doova / HUA-H / bibo / Amoo / iKairos / 安安 / 雷格斯 / 诺恩智伴 等条目改作「阶段雷达」，供对应阶段回看；Bubbo / 二白Mini / JUOS / Microduck / Plaud One / 优必选 U1 / 小度 Pro Max / 糯宝(Robie) / 小沐学伴 仍纯反定位。童声 500–800 ms 停顿写成「不截断」，不写成「更懂情绪」。

2026-09-17 阶段雷达日历：优必选 U1 声称交付日 +1。**官方媒体称 9/16 已开启交付，但截至 2026-09-17 扫描仍未见用户签收/开箱/到货实锤**（OFweek 2026-09-16 14:28：「今日，优必选 U1机器人开启交付」，并重申全年可交付仅 1500–2000 台、对比订单约 1.3 万；https://robot.ofweek.com/2026-09/ART-898890-12003-30703390.html ；沿用红星资本局 2026-09-03 + 京东约 60 天 / 9/15 后有货口径；2026-09-14 21世纪经济报道（新浪转载）：周剑 8 月底承认广西工厂因自然因素投产推迟两三个月，要到 9 月中下旬才能批量交付，深圳产能补位；全年可交付仍 1,500–2,000 台，对比预售约 1.34 万 / 13,361，柳州工厂延期；https://leaderobot.com/news/9425 ；https://www.163.com/dy/article/L5U2PKT60511U82T.html ；https://finance.sina.com.cn/roll/2026-09-14/doc-iniruark4819871.shtml）。工匠行智能诺恩智伴见 R-20260917-01（阶段雷达·老年后期；价格未披露，不作对客对照价带）。小度智能音箱 Pro Max 9/28 开售见 R-20260914-01（反定位·智能音箱/家庭 Agent，订阅叙事不对照 ¥299 音箱）。无芯科技安安欧洲 2026-09 开售见 R-20260914-02（阶段雷达·老年后期；Duncan 仅旁证学生线，不新开 id）。糯宝 Robie / Pophie 见 R-20260915-01（反定位·桌面萌宠）。心言巴布 Bubbo 1 京东预定见 R-20260916-01（纯反定位·家庭主动智能毛绒伴侣；本扫描未核到明确挂牌价）。德志善元小沐学伴精灵公测早鸟约 ¥2999 见 R-20260916-02（纯反定位·小学生作业托管桌面机；计划约 9/25 发货、10/25 到齐，以官方页为准）。钉钉 A1 教育版 ¥1099 见 R-20260916-03（纯反定位·教师课堂笔记 Agent，不是学生陪伴；价带对照仍可保留钉钉 A1）。雷格斯服贸会 AI 潮玩基础 ¥599 / 限定 ¥799 见 R-20260916-04（阶段雷达·年轻人潮玩后期）。Doova / Amoo / iKairos / bibo / HUA-H 不新开 id（R-20260910-03 / R-20260910-04 / R-20260911-02 / R-20260911-03 / R-20260911-04）。MOMOface M1 无价格/发货，不新开 id。海信 JUOS 约 8/31–9/3 起对首批电视/投影推 Sep OTA；小聚识人非默认，声纹/人脸需登记（https://www.3elife.net/Art/ie/202609/04/109709.html）；仍是 TV/AIOS 全家中枢，纯反定位。Plaud One 仍 explorer $249.99，未见大陆零售 SKU。Microduck 灰色市场国内约至 ¥5567（https://www.yicai.com/news/103350821.html）。华泰 ¥2000–4000 价带本月无修订。Bubbo / 二白Mini / JUOS / Microduck / Plaud One / 优必选 U1 / 糯宝(Robie) / 小沐学伴 仍纯反定位。
...
- 开发备注：Agent 已有 `funasr_empty_accounting`。2026-09-14 已纠正消费方口径；上游 PyPI latest=1.4.15 不证明 DashScope 或救援镜像使用该包。现有分账与空输入恢复保留，剩余是运行来源核验、同条件测试与真实链路验收。2026-09-15：官方 PyPI latest 仍 1.4.15，无更新上传；不宣称 FunASR>1.4.15。2026-09-16：官方 PyPI latest 仍 1.4.15（upload 仍 2026-09-09），无更新包；不宣称 FunASR>1.4.15。2026-09-17：官方 PyPI latest 仍 1.4.15（upload 2026-09-09T04:03:48Z），无 1.4.16+；不宣称 FunASR>1.4.15。DashScope/sidecar 消费方口径不变。
...
- 开发备注：2026-09-14 官方 PyPI latest=1.4.15；采纳的是「核实消费方并补可复现构建」，不是批准升级/切流。上游 NumPy 2 测试仅覆盖其公布环境，不能外推到未知 Torch/模型组合。sidecar 独立发布；如改主项目依赖，仍必须遵守完整镜像构建门禁。2026-09-15：官方 PyPI latest 仍 1.4.15，无更新包；不宣称 FunASR>1.4.15。2026-09-16：官方 PyPI latest 仍 1.4.15，无 >1.4.15 包；不宣称 FunASR>1.4.15。2026-09-17：官方 PyPI latest 仍 1.4.15（upload 2026-09-09T04:03:48Z），无 1.4.16+；不宣称 FunASR>1.4.15。DashScope/sidecar 消费方口径不变。
...
- 为何现在相关：生产 Agent/Bridge 已钉档 livekit-agents/openai/silero **1.8.1**（切流时阿里云镜像有 1.8.1 无 1.8.2；与 HANDOFF 2026-09-16 口径一致）。上游 PyPI latest 仍 **1.8.2**（agents upload 2026-09-15T18:13:59Z；GitHub 2026-09-15T19:48:21Z；plugins openai/silero 亦 1.8.2）。1.8.2 仅为评估项，不自动升级。RTC 仍 1.1.18，API 仍 1.2.1。旧「仓内均 1.6.10」基线已过时。1.8.2 changelog 主题：asyncio run-loop blocking detection、prefork library preload（约缩短启动）、更完整的 lifecycle/dispatch tracing。DuplexModel 已随 1.8.x 吸收，但仍只观察、不接生产：1.8.2 修了 refuse-under-text-simulation（#7236）与 late-transcript alignment（#7264），这不是设备全双工或 barge-in 证据。收益要在本项目实测，不能承诺解决现有 ASR/硬件问题。
- 建议下一步：1.8.2 仍走 `TODOLIST.md` P1-01 评估口径（本地兼容性→完整镜像→独立上线验收），不建议自动升到 1.8.2。LiveKit 侧保留 dispatch metadata→`controlled_half_duplex_session`，设备 Voice Core 侧保留 `audio_mode` 派生逻辑；兼容半双工路径禁打断、默认 preemptive 关闭。验证 TypedDict 字段实际被消费，不能只测构造成功。#7104 将对话 event 改 attributes，并变更 span/计量；内容采集与 PII 默认仍开启，要显式禁内容/PII并验证实际 exporter 不泄漏。DuplexModel 仍只观察；禁止搭车开启 `user_turn_limit`、`expressive=True`、TurnPhase 副作用或放行设备语音打断。
...
- 开发备注：2026-09-14 已核官方包元数据与本仓消费点。#7064 于 2026-08-31 合并并随 1.8.0 发布；本仓 RoomIO 显式 `auto_gain_control=True`、未配置 NC，所以「NC 时默认关 AGC」不改变现有行为。1.8.1 的 DuplexModel 只观察，不接生产；禁止搭车开启 `user_turn_limit`、`expressive=True`、TurnPhase 副作用或放行设备语音打断。`OTEL_INSTRUMENTATION_GENAI_CAPTURE_MESSAGE_CONTENT=0` 与 `LIVEKIT_TELEMETRY_ALLOW_PII=0` 需结合实际导出测试；锁变化不走 agent-only overlay。2026-09-15：官方 PyPI latest 仍 1.8.1，未见 1.8.2/1.9；DuplexModel 仍只观察。升级评估仍走 `TODOLIST.md` P1-01，不宣称 LiveKit>1.8.1。2026-09-16：官方 PyPI latest 现为 1.8.2（openai/silero 插件同版本）；当时仓内仍记 1.6.10。DuplexModel 仍只观察 / 不接生产；#7236/#7264 不是 VoCat 全双工或 barge-in 证据。P1-01 应评估 1.8.2 三者同组 + RTC 1.1.18 / API 1.2.1。2026-09-17：与 HANDOFF 对齐——生产 Agent/Bridge 已钉档 **1.8.1** 同组（切流时阿里云镜像有 1.8.1 无 1.8.2）；上游 latest 仍 **1.8.2**（agents upload 2026-09-15T18:13:59Z；openai/silero 亦 1.8.2）。不建议自动升 1.8.2，仅作本条评估。旧「仓内均 1.6.10」作废。DuplexModel 仍只观察 / 不接生产。
  - **2026-09-15 本地候选与实测结论**：本仓锁当时落到的是 **1.8.1** 同组 7 项（`livekit-api` 需 `>=1.2.1`、`livekit-protocol` 需 `>=1.1.25`，否则 uv 会保留旧 protocol 1.1.22 而不满足 API 1.2.1 的约束——这一点比上一轮评估更具体）。**1.8.2 于 2026-09-15T18:13:57Z 才发布（openai/silero 插件 19:31Z），晚于该轮取版本的时刻**，所以候选锁是 1.8.1 而非 1.8.2。发布前曾按用户决定临时升到 1.8.2 重验，但生产机 `UV_DEFAULT_INDEX` 默认指向的阿里云镜像尚未同步 1.8.2（只有到 1.8.1），构建在 `uv export` 阶段直接失败，用户遂改为发布 1.8.1。
  - **TypedDict 消费核实已落地**：逐键比对 `TurnHandlingOptions`/`EndpointingOptions`/`InterruptionOptions`/`PreemptiveGenerationOptions` 注解，本仓传入键**零丢弃**；`AgentSession._opts.turn_handling` 回读值一致；`{"version": ...}` 被物化为 `TurnDetector`，可用 `model == "turn-detector-<version>"` 反查。1.8.x 新增 `user_turn_limit` 默认 `max_words=None`/`max_duration=None`，**未生效**。
  - **PII 门已取得 in-process 证据**：上游在未显式配置时**确实**把对话内容交给第三方 exporter（反证用例验证），显式 `allow_pii=False` 或 `LIVEKIT_TELEMETRY_ALLOW_PII=0` 后五处内容属性消失而非内容计量保留。SDK 的 env 规则是**未设置/空串=采集**、只有 `0/false/no/off` 关闭，且 `capture_content` 在 **SDK 导入期**求值——所以必须放在进程启动环境，不能只在应用代码里事后改。这是 exporter 级证据，不是生产网络抓包；LiveKit Cloud dashboard 侧设置本轮未核。仓库里 `PII_REDACTION_ENABLED=true` 只被 `scripts/split_production_env.py` 归类，**无 Python 代码消费**，也不是 SDK 的 redaction 开关（后者来自 job context / Cloud dashboard），不要把它当作已接线。
...
- 为何现在相关：令第25号已生效，声纹仍要单独同意，2026-09-16/09-17 无新声纹细则。大型处理者征求意见截止已过、截至 2026-09-17 仍无正式文本/延期公告/解读（https://www.cac.gov.cn/2026-08/07/c_1787851071612596.htm）；当前按小型处理者，不扩编守门人组织。清朗二阶段 2026-09-02 CAC 稿（https://www.cac.gov.cn/2026-09/02/c_1790099041364574.htm）为执行进展（清理 561 万余条等），非正式新规章；无 9/10–9/17 新法规。CAC 备案公告仍以 2026-09-14《生成式人工智能服务已备案信息的公告（2026年7月至8月）》为最新（https://www.cac.gov.cn/2026-09/14/c_1791136833136332.htm）。2026-09-15 CAC 执法典型案例（https://www.cac.gov.cn/2026-09/15/c_1790876152357946.htm）**不是新法**：案例9 微信小程序提供 AI 文本/图片生成，未加显式标识、未在元数据加隐式标识、导出未标识，且未落实安全评估 → 责令下线（深度合成管理规定 + 标识办法 + 舆论属性安全评估）；案例10 API 中转生成式对话未做安全评估 → 责令改正/警告。直接相关 memoria 小程序控制面 + 合成语音/导出标识 + 安全评估。最高法涉人工智能纠纷意见是司法意见不是 CAC 新法，拟声/训练语料见 R-20260910-02。导出是用户语音+模型回复混合物，执法点在文件标识。拟人化办法的落地页/2h 提醒已在小程序完成（原 R-20260831-13）。
- 建议下一步：默认云端只存转写+记忆条目；原始 wav/特征不长期留、不用于声纹登录。声纹单独同意，不并入一般同意。导出 JSON/音频包里模型侧显式「AI 生成」，元数据写服务提供者+内容编号；TTS 对齐 `aigc_watermark` + `aigc_metadata`。对照 2026-09-15 案例9/10 核小程序与导出的显式/元数据标识及安全评估口径，不新开法规 id。五个吉祥物禁止亲属/伴侣角色。家庭邀请只给控制面权限，写档案仍要设备端 owner 声纹。继续盯大型处理者正式文本，不新开法规 id。
- 来源：https://www.cac.gov.cn/2026-07/24/c_1786638889704872.htm ；https://www.cac.gov.cn/2026-08/07/c_1787851071612596.htm ；https://www.cac.gov.cn/2026-09/02/c_1790099041364574.htm ；https://www.cac.gov.cn/2026-09/14/c_1791136833136332.htm ；https://www.cac.gov.cn/2026-09/15/c_1790876152357946.htm ；https://www.gov.cn/zhengce/zhengceku/202503/content_7014286.htm ；https://docs.volcengine.com/docs/6561/1598757
- 开发备注：2026-09-14 NEW_LAW_IDS（法规/CAC）空。Seed-TTS `aigc_watermark` / `aigc_metadata` schema 仍 NO_CHANGE（https://docs.volcengine.com/docs/6561/1598757）。不把大型处理者征求意见稿写成已生效；不把清朗二阶段进展稿写成新规。2026-09-15：大型处理者征求意见稿仍无定稿；清朗二阶段仍以 9/02 进展稿为最新执行报道。NEW_LAW_IDS（法规/CAC）空。令第25号/拟人化办法无本周新细则。2026-09-16：NEW_LAW_IDS（法规/CAC）空——2026-09-15 执法通报不是新法/新法规号。大型处理者征求意见稿仍无定稿；清朗二阶段仍以 9/02 进展稿为最新执行报道。CAC 备案公告仍以 2026-09-14 为最新。案例9/10 加强小程序/导出标识与安全评估，不新开 id。令第25号/拟人化办法无本周新细则。法发〔2026〕10号仍走 R-20260910-02。2026-09-17：NEW_LAW_IDS（法规/CAC）空。09-16/09-17 无新 CAC 法规；2026-09-15 执法典型案例通报已并入本条，不新开 id。
...
- 首次写入：2026-09-16
- 最近更新：2026-09-16
- 为何现在相关：公测早鸟约 ¥2999（原价约 ¥6999，主机+功能+Token）；书桌摄像头盯作业、教材同步、错题/学情、家长 App；计划约 9/25 开始发货、10/25 到齐（以官方页为准）。Phase1 学生线强反定位：memoria 是陪伴/tutor 语音+档案，不是作业托管机。
- 建议下一步：纯反定位；不对照改 ESP-VoCat SKU/价带；不新开作业托管/书桌盯拍/学情 App 工单。订阅叙事继续卖学生陪伴/教学导师价值，不对照作业机功能清单。
- 来源：https://www.dezhishanyuan.com/detail?id=1714 ；https://bd.zhizeu.com/robot/xiaomu/xiaomu-preorder.html
- 开发备注：与「前期学生陪伴/教学导师」叙事相邻但形态相反（作业托管机 vs 陪伴语音档案终端）。不并入 bibo/Amoo 潮玩雷达，也不对照 ¥2999 作业机改价带。

### R-20260916-03 钉钉 A1 教育版（反定位·教师课堂笔记 Agent）
...
- 开发备注：价带对照仍走钉钉 A1 / 安克×飞书（约 ¥499–1299）；本条只钉教育版是教师课堂笔记 Agent，不是学生陪伴硬件。由原 R-20260916-02 顺延编号，不保留重复标题。

### R-20260916-04 雷格斯（服贸会 AI 潮玩；阶段雷达·年轻人潮玩后期）

- 类别：市场定位
- 状态：待评估
- 首次写入：2026-09-16
- 最近更新：2026-09-16
- 为何现在相关：新京报 2026-09-13 服贸会报道：情绪陪伴潮玩雷格斯基础款 ¥599、限定款 ¥799；基础款无预设性格可养成，限定款含固定角色；超长记忆、满电一整天陪伴。与 bibo 同类年轻人潮玩信号。同期展区另有桌面小狗、AI 毛绒挂件；MOMOface M1 无价格/发货，不新开 id。
- 建议下一步：挂「阶段雷达·年轻人潮玩后期」；当前阶段不新开潮玩工单，不对照改 ESP-VoCat SKU/价带。
- 来源：https://www.bjnews.com.cn/detail/1789270215169962.html
- 开发备注：与 R-20260911-03 bibo 同类阶段雷达；不并入 Bubbo/糯宝纯反定位桌面萌宠家族。不复制 MOMOface id。
