...
- 当前唤醒词是「茉莉」。短于 ESP-SR 建议的 3–6 音节；误唤醒与漏唤醒要记数，不要开播放期 KWS。
...
- 首次写入：2026-08-31
- 最近更新：2026-08-31
- 为何现在相关：当前唤醒词「茉莉」只有两音节，低于 ESP-SR 定制唤醒词建议的 3–6 音节门槛。
- 建议下一步：阶段 4 安静环境 ×10，分别记漏唤醒 / 误唤醒。误唤醒高则加 WakeNet 阈值，或改回 ≥3 音节。不要开播放期 KWS。
...
### R-20260831-09 投资人 3 分钟剧本卖 H5 证据档案

- 类别：市场定位
- 状态：待评估
- 首次写入：2026-08-31
- 最近更新：2026-08-31
- 为何现在相关：对照 Plaud NotePin S 与 Friend 2.0（$10/月记 30 天）。不演「越来越懂我」。
- 建议下一步：剧本顺序：主人事实 → claim + 说话人 → 访客取不到 → H5 证据链 → 删除。
...
- 建议下一步：落地页二选一：家庭档案终端 vs 拟人化陪伴。学生账号禁止虚拟亲属 / 伴侣。H5 导出 / 删除；训练默认关；会话标明 AI；2 小时提醒。
...
- 建议下一步：配网 / 选角 / 声纹在设备录、微信确认、学生账号、静音、跳 H5。家庭共享。
