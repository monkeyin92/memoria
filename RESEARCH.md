...
- 扫描日期：2026-09-04。本轮追加 R-20260904-01..03；加强 R-20260831-02/04/05/08/13/20 与 R-20260901-04/09/10 与 R-20260902-02/05 与 R-20260903-01/03。NEW_LAW_IDS 空。大型个人信息处理者征求意见稿评论仍至 2026-09-07。
...
- 首次写入：2026-08-31
- 最近更新：2026-09-04
- 为何现在相关：半双工 SKU 不能靠 barge-in 制造“在听”。对照 LiveKit agents #6451（`allow_interruptions=False`）：丢掉 thinking 中的旧 generation，比抢话更接近陪伴感。LiveKit `TurnHandlingOptions`：`interruption.enabled=False` + `preemptive_generation.enabled=False`；#6858 已由 #6865 于 2026-09-01 合入 livekit/agents main；#7016 于 2026-09-02 关闭（重复）。最新发行仍是 livekit-agents@1.7.1（2026-08-27），无更新发行。文档 2026-09-04 仍默认 interruption/preemptive 为开。#7064（2026-08-31 merged，NC 开时默认关 AGC）未进 1.7.1。
- 建议下一步：屏上 idle / listening / speaking 可做。BOOT 仍是唯一硬停。半双工显式关打断与抢跑，见 R-20260902-02。不要因为 #6858 / #7064 已修就打开 preemptive_generation、user_turn_limit 或 barge-in。
- 来源：https://github.com/livekit/agents/pull/6451 ；https://docs.livekit.io/reference/agents/turn-handling-options/ ；https://github.com/livekit/agents/issues/7016 ；https://github.com/livekit/agents/issues/6858 ；https://github.com/livekit/agents/pull/6865 ；https://github.com/livekit/agents/pull/7064
...
- 建议下一步：公开故事写成「家庭桌面记忆终端 / 声纹档案音箱」。不是 7 寸数字人、跌倒看护或智家中枢。按需档案带见 R-20260902-05；Bubbo 反定位见 R-20260902-06。JUOS / Microduck 反定位见 R-20260904-02 / R-20260904-03。
...
- 来源：https://www.cac.gov.cn/2026-04/10/c_1777558395078289.htm ；https://www.news.cn/politics/20260731/26fdd0534922429bae213b5f6f3122ec/c.html ；https://www.cnr.cn/mspd/sywzl/20260831/t20260831_527800024.shtml ；https://paper.people.com.cn/rmrb/pc/content/202609/03/content_30178849.html
...
- 首次写入：2026-09-02
- 最近更新：2026-09-04
- 为何现在相关：半双工 SKU 不能抄 LiveKit 默认全双工。`TurnHandlingOptions` 要把 `interruption.enabled=False` 与 `preemptive_generation.enabled=False` 写死。#6858 已由 #6865 于 2026-09-01 合入 main；#7016 于 2026-09-02 关闭（重复）。最新发行仍是 livekit-agents@1.7.1（2026-08-27），无更新发行。文档 2026-09-04 仍默认打断/抢跑为开，并新增 `user_turn_limit`（超时抢话）——现 SKU 不要设。#7064（2026-08-31 merged，NC 开时默认关 AGC）未进 1.7.1。
- 建议下一步：对照现会话 `barge_in_enabled=false` / `interruptions_enabled=false`，在 Voice Core 配置里显式关打断与抢跑。不要等发行版带上 #6865 / #7064 再抄默认值。不要启用 `user_turn_limit` 或 `expressive=True`。勿因 #7064 开 barge-in。
- 来源：https://docs.livekit.io/reference/agents/turn-handling-options/ ；https://github.com/livekit/agents/issues/7016 ；https://github.com/livekit/agents/issues/6858 ；https://github.com/livekit/agents/pull/6865 ；https://github.com/livekit/agents/pull/7064 ；https://github.com/livekit/agents/releases/tag/livekit-agents%401.7.1
...
- 建议下一步：公开价与订阅对齐按需档案带：硬件一次性 + 档案容量/席位/导出。不要卖常开陪伴月费。守桌面不跟耳机 Agent。对照 R-20260831-08 / R-20260901-10。
- 来源：https://www.donews.com/article/detail/8612/95906.html ；https://www.ys7.com/item/927621.html ；https://www.ithome.com/0/996/945.htm ；https://www.plaud.ai/products/plaud-one
...
- 开发备注：2026-09-03 不要开 LiveKit Agents 1.7.0 `expressive=True`（会话情感标签驱动 TTS 韵律），也不要把二白Mini「领养/生命模块」或 Bubbo「有灵魂的生命体」写进对外口径。2026-09-04：勿把 JUOS「家庭智能伴侣/全时段陪伴」或 Microduck 玩具热度写进对外口径。
